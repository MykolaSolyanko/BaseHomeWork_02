...
int main() 
{
    ...
    std::cout << "Please enter value for variable 'a' from " << kMin << " till " << kMax << ", and press 'Enter':";
    while ( !( std::cin >> var_a ) || std::cin.fail() || var_a < kMin || var_a > kMax ) {
        std::cin.clear();
        std::cin.ignore(std::numeric_limits<long long>::max(), '\n');
        std::cout << "You set incorrect value for variable 'a', please enter again variable 'a' from " << kMin << " till " << kMax << ", and press 'Enter':";
    }
    std::cout << "You are successfully set variable 'a' = " << var_a << std::endl;
    
    
    long long var_b {};
    std::cout << "Please enter value for variable 'b' from " << kMin << " till " << kMax << ", and press 'Enter':";
    while ( ! ( std::cin >> var_b ) || std::cin.fail() || var_b < kMin || var_b > kMax ) {
        std::cin.clear();
        std::cin.ignore(std::numeric_limits<long long>::max(), '\n');
        std::cout << "You set incorrect value for variable 'b', please enter again variable 'b' from " << kMin << " till " << kMax << ", and press 'Enter':";
        
    }
    std::cout << "You are successfully set variable 'b' = " << var_b << std::endl;

    long long var_c {};
    std::cout << "Please enter value for variable 'c' from " << kMin << " till " << kMax << ", and press 'Enter':";
    while ( ! ( std::cin >> var_c ) || std::cin.fail() || var_c < kMin || var_c > kMax ) {
        std::cin.clear();
        std::cin.ignore(std::numeric_limits<long long>::max(), '\n');
        std::cout << "You set incorrect value for variable 'c', please enter again variable 'c' from " << kMin << " till " << kMax << ", and press 'Enter':";
