...

  {
    Stack<float> st_float;
    {
      ...
      while (pair.status == true) {
        ...
        Value<float> topy = st_float.top<float>();
        std::cout << "Pushed: " << topy.msg << std::endl;
      }
      std::cout << pair.msg << std::endl;
    }
    {
      for (Pair pair{true, ""}; pair.status == true;
           pair = st_float.pop(pair)) {
        Value<float> topy = st_float.top<float>();
        std::cout << "Popped: " << topy.msg << std::endl;
      }
    }
...

  {
    Stack<char> st_char;
    {
      ...
      while (pair.status == true) {
        ...
        Value<char> topy = st_char.top<char>();
        std::cout << "Pushed: " << topy.msg << std::endl;
      }
      std::cout << pair.msg << std::endl;
    }
